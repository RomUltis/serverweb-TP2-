...
const bddConnection = mysql.createConnection(
    {
        host: "192.168.65.57", // ip du server mariadb  
        database: "BaseMedecinImporte", //nom de la base de donnée dans phpmyadmin
...
bddConnection.connect(
    function (err) { if (err) throw err; console.log("Romain est Connecté à la base !"); }
);
...
app.post(
    ...
    (req, res) => {
        ...
        bddConnection.query(query, [req.body.nom, req.body.prenom]);
